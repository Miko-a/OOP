...
public class StudentRecordSystem { 
    public static void main(String[] args) { 
        ArrayList<Student> records = new ArrayList<>();  Scanner scanner = new Scanner(System.in); 
        int choice; 
        ...
        do { 
            ...
            switch (choice) { 
                case 1: 
                    ...
                    records.add(new Student(nim, name, major));  System.out.println("Mahasiswa berhasil ditambahkan!");  
                    break; 
                ...
                case 4: 
                    System.out.print("Masukkan NIM mahasiswa yang akan dihapus: ");  String deleteNim = scanner.nextLine(); 
                    ...
                    break; 
                case 5: 
                    System.out.println("Keluar dari sistem. Terima kasih!");  break; 
                default: 
